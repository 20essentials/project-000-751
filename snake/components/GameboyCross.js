class GameboyCross extends HTMLElement {
  ...
  addListeners() {
    ...
    const parentComponet = $('.container');
    parentComponet.addEventListener('click', e => {
      if (e.target.matches('.button-top')) {
        this.dispatchEvent(
          new CustomEvent('snake-to-top', { bubbles: true, composed: true })
        );
      } else if (e.target.matches('.button-right')) {
        this.dispatchEvent(
          new CustomEvent('snake-to-right', { bubbles: true, composed: true })
        );
      } else if (e.target.matches('.button-left')) {
        this.dispatchEvent(
          new CustomEvent('snake-to-left', { bubbles: true, composed: true })
        );
      } else if (e.target.matches('.button-bottom')) {
        this.dispatchEvent(
          new CustomEvent('snake-to-bottom', { bubbles: true, composed: true })
        );
      }
    });
  }
